  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
          ...
          <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>Kshs. 150,000</h6>
                      <span class="text-success small pt-1 fw-bold">92%</span> <span class="text-muted small pt-2 ps-1">increase</span>
            ...
            <div class="col-xxl-4 col-md-6">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Tenants <span>| This Year</span></h5>
            ...
            <!-- Reports -->
            <?php include("report_section.php")?>
            <!-- End Reports -->
            
            <!-- Recent Sales -->
            
            <?php include("recent_sales.php")?>
            <!-- End Recent Sales -->
        ...
        <div class="col-lg-4">
          <!-- Budget Report -->
          <!-- <?php include('budget_report.php')?> -->
          <!-- End Budget Report -->

          <!-- Website Traffic -->
          <?php include("web_traffic.php")?>
          <!-- End Website Traffic -->
